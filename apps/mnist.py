...
x_train,y_train,x_test,y_test,featureShape = tensorflow.get_mnist_dataset(input_h, input_w, input_c)
...
lib.generate_vhdl_package(modelDict,shift,input_size,filter_dimension[0],filter_channel[0],stride_h[0],stride_w[0],layer_dimension[0],1,1,x_test)
